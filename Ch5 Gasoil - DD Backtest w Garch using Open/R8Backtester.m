...
function R8Backtester(w,shift,gasoil_data,gaoil_data_close,offset,ma,excel_row,excel_columnc,excel_columnd,excel_columne,excel_columnf,excel_columng,excel_columnh,excel_columni,excel_columnj)%gaoil_data_close,excel_row,date,time,indicator)
%w=20;
%shift=0;
