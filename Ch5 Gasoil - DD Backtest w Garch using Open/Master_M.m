...
%moving columns. 2. Shift change to 3 for speed. 3. Only 1 week for speed.
%4. Brent Crude oil data used instead. 


%The layout of my study is as follows: 
%%PW Edit, removing 0.5 hourly code to speed up process. This must be
%%reinstated later. 
...
filename = 'Gasoil';
sheet1 = 5; % This is the 0.5hrWeekly Feb tab
alphaRange = 'C33464:C33675';
closeRange = 'F33464:F33675';
alpha=xlsread(filename, sheet1, alphaRange);
gasoil_data_close=xlsread(filename, sheet1, closeRange);
%alpha = flipud(alpha_reverse);
gasoil_data = alpha;
%[n]= numel(alpha);
addpath('C:\Users\Walsh_pad\Dropbox (Personal)\Further Study\Thesis\myfiles\AppendixB\Chapter 5 - Experiment 1 - Optimisation_Brent')
...
for w =[2 5 ];%10 15 20 25 50 100 200];
excel_row=excel_row+1;
