%%PW 29-07-2017
%%Messing with GARCH 
%%The purpose of this mFile is to calculate the volatility of Gasoil daily
%%using Garch(1,1). 
...
%%3.5 For the sake of comparing to my thesis work, change variance to
%%volatility (std. deviation...remembering std deviation = sqrt(variance))
volatility=sqrt(v);
figure
plot(volatility)
xlim([0,T])
title('Inferred Conditional Std Deviation AKA Volatility')
