...
% signalName='TradingPerfDDGasoil';w=20; shift=0.5;offset=6;ma=1;  sp500Index=transpose(sp500Gasoil); spGsciIndex=transpose(sp500GsciGasoil);
...
% R12Backtester_Volatility_Econometrics (signalName,sp500Date, sp500Index,spGsciIndex,w,shift,data,gasoil_data_close,date,offset,ma,mmdate,returnsSignal,interestFreeRate,interestFreeRateDaily)
%% 5. Obtain the Alpha Signal for Alpha DD Crude 
%Set the Window, Shift, MA, and Offset, where Offset is used in older Excel. 
clear signalName w shift offset ma sp500index sp500Date date mmdate data returnsSignal interestFreeRate interestFreeRateDaily;
w=20; shift=0.5;offset=6;ma=1;  sp500Index=transpose(sp500Crude); spGsciIndex=transpose(sp500GsciCrude);
