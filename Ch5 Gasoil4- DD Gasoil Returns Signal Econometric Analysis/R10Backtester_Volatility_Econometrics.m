...
function R10Backtester_Volatility_Econometrics (signalName, w,shift,data,gasoil_data_close,date,offset,ma,mmdate,returnsSignal,interestFreeRate,interestFreeRateDaily)
% The idea of R10 is that any variables are passed from Master. If using
% Gasoil or Crude, all changes made in MasterXXX.m 
% sp500Date is the date associated with S&P500 baseline. 
...
%% 9.   PLOT: Figure 1 - Volatility Comparison: Gamma, Stoch Volatility, Garch Vol, and LI (Gamma/Volatility) 
figure2 = figure;
...
figure(2); 
plot(x,signal_norm,'b',x,LI,'r',wx,tally3_norm,'-m.',count,indicator,'-c',x,ZC,'g',x,v2,'m','Markersize',15);
