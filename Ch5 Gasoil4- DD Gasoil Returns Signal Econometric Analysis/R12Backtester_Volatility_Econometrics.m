...
function R12Backtester_Volatility_Econometrics (signalName, sp500Date, sp500Index,spGsciIndex,w,shift,data,gasoil_data_close,date,offset,ma,mmdate,returnsSignal,interestFreeRate,interestFreeRateDaily)
...
%try
if ma ==1;
gamma=movav_R0(gamma,m,w,shift);
stoch_sigma=movav_R0(stoch_sigma,m-1,w,shift);
garch_sigma=movav_R0(garch_sigma,m-1,w,shift);
else
    gamma=gamma;
    sigma=sigma;
end
