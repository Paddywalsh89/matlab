...
function R8Backtester_Brent(w,shift,gasoil_data,gaoil_data_close,offset,ma,excel_row,excel_columnc,excel_columnd,excel_columne,excel_columnf,excel_columng,excel_columnh,excel_columni,excel_columnj)%gaoil_data_close,excel_row,date,time,indicator)
%w=20;
%shift=0;
...
plot(x,signal,'b-',x,LI,'r-',x,ZC_plot*100,'g-',x,v1,'m',x,v2,'m')%,x,gamma_no_MA*100);
...
xlswrite(filename, names,2,'B1:E1')
xlswrite(filename,out,2,'B2:E30')
xlswrite(filename,datarange,2,'A33:A33')
