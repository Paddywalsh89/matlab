...
r = double((log(alpha(2:end)./alpha(1:end-1)))*100);
...
%%calc. 
R8Backtester_Volatility_returns (spDate, sp, w,shift,gasoil_data,gasoil_data_close,date,offset,ma,excel_row,excel_columnc,excel_columnd,excel_columne,excel_columnf,excel_columng,excel_columnh,excel_columni,excel_columnj,mmdate,r)
 %end
% end
    %else
