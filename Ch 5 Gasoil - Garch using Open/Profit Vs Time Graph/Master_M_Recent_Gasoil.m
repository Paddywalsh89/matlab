%This is a central matlab m-file that will call all other sub m-files required for my PhD study. %%
%01/03/16 _tester used to test change of MA to remove snooping. 
%20/03/2016 1. Output changed so that Excel tabe is all in one line, no
%moving columns. 2. Brent Crude oil data used instead of Gasoil. 
%3. Instead of 3 sets of weekly, monthly, 6monthly etc., just 1 test for
%most recent week, month, 6 month, year. Do the other tess another time. 
...
% filename = 'Gasoil';
% sheet1 = 3; 
% alphaRange = 'C3:C7'; %4th  - 8th Oct 2010
% closeRange = 'F3:F7';
...
% gasoil_data = alpha;
% %[n]= numel(alpha);
% addpath('C:\Users\Walsh_pad\Dropbox (Personal)\Further Study\Thesis\myfiles\AppendixB\Chapter 5 - Experiment 1 - Optimisation_Gasoil_Daily')
...
% excel_row=excel_row+1;
% R8Backtester (w,shift,gasoil_data,gasoil_data_close,offset,ma,excel_row,excel_columnc,excel_columnd,excel_columne,excel_columnf,excel_columng,excel_columnh,excel_columni,excel_columnj)
% end
% end
% end
% %%Monthly data%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% filename = 'Gasoil';
% sheet1 = 3; 
% alphaRange = 'C2:C22'; %4th  - 29th Oct 2010
% closeRange = 'F2:F22';
% alpha=xlsread(filename, sheet1, alphaRange);
% gasoil_data_close=xlsread(filename, sheet1, closeRange);
% %alpha = flipud(alpha_reverse);
...
% filename = 'Gasoil';
% sheet1 = 3; 
% alphaRange = 'C2:C127'; %1th Oct 2010  - 31st March 2011
% closeRange = 'F2:F127';
% alpha=xlsread(filename, sheet1, alphaRange);
% gasoil_data_close=xlsread(filename, sheet1, closeRange);
% %alpha = flipud(alpha_reverse);
...
% filename = 'Gasoil';
% sheet1 = 3; 
% alphaRange = 'C2:C258'; %1st Oct 2010  - 3rd Oct 2011
% closeRange = 'F2:F258';
% alpha=xlsread(filename, sheet1, alphaRange);
% gasoil_data_close=xlsread(filename, sheet1, closeRange);
% %alpha = flipud(alpha_reverse);
...
gasoil_data = alpha;
%[n]= numel(alpha);
addpath('C:\Users\Walsh_pad\Dropbox (Personal)\Further Study\Thesis\myfiles\AppendixB\Chapter 5 - Experiment 1 - Optimisation_Gasoil_Daily_Charts')
w=20; shift=0;offset=6;ma=1;
clear shift w
excel_row=1;
excel_columnc=3;excel_columnd=4;excel_columne=5;excel_columnf=6;excel_columng=7;excel_columnh=8;excel_columni=9;excel_columnj=10;
...
for shift = 0.5; 
    %%excel_columnc=excel_columnc+9;excel_columnd=excel_columnd+9;excel_columne=excel_columne+9;excel_columnf=excel_columnf+9;excel_columng=excel_columng+9;excel_columnh=excel_columnh+9;excel_columni=excel_columni+9;excel_columnj=excel_columnj+9;
    excel_row=excel_row+1;
for w =[20];%10 15 20 25 50 100 200];
excel_row=excel_row+1;
R8Backtester (w,shift,gasoil_data,gasoil_data_close,offset,ma,excel_row,excel_columnc,excel_columnd,excel_columne,excel_columnf,excel_columng,excel_columnh,excel_columni,excel_columnj)%,date)
end
end
%end
%%Brent 4 Year
...
for shift = 0; 
    %%excel_columnc=excel_columnc+9;excel_columnd=excel_columnd+9;excel_columne=excel_columne+9;excel_columnf=excel_columnf+9;excel_columng=excel_columng+9;excel_columnh=excel_columnh+9;excel_columni=excel_columni+9;excel_columnj=excel_columnj+9;
    excel_row=excel_row+1;
for w =[25];%10 15 20 25 50 100 200];
excel_row=excel_row+1;
R8Backtester_Brent (w,shift,gasoil_data,gasoil_data_close,offset,ma,excel_row,excel_columnc,excel_columnd,excel_columne,excel_columnf,excel_columng,excel_columnh,excel_columni,excel_columnj)
end
end
%end
...
% % R8Backtester (w,shift,gasoil_data,gaoil_data_close,offset,ma)
% % %R8Backtester (w,shift,gasoil_data,gaoil_data_close)
...
% % R8Backtester (w,shift,gasoil_data,gasoil_data_close,offset,ma)
...
% % w=20; shift=0;
% % R8Backtester (w,shift,gasoil_data)
...
% % shift=0; R8Backtester (w,shift,gasoil_data)
% % 
...
% for w =[2 5 10 15 20 25 50 100 200];%10 15 20 25 50 100 200];
% excel_row=excel_row+1;
% R8Backtester_Lyapunov (w,shift,gasoil_data,gasoil_data_close,offset,ma,excel_row,excel_columnc,excel_columnd,excel_columne,excel_columnf,excel_columng,excel_columnh,excel_columni,excel_columnj)
% end
% end
% end
% %%Monthly data%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
